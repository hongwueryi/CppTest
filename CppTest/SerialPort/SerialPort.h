...
public:
    ...
    typedef enum
    {
        ...
        EHandshakeOn = 1,
        EHandshakeHardware = 2,	// Hardware handshaking (RTS/CTS)
        EHandshakeSoftware = 3	// Software handshaking (XON/XOFF)
    }
    EHandshake;
...
public:
    ...
    int GetLegelPortName( LPCTSTR lpPort, LPTSTR stOut, int len );
    ...
    virtual LONG Setup( EBaudrate eBaudrate = EBaud9600,
                        ...
                        EStopBits eStopBits = EStop1 , int fDtrControl = 0);
